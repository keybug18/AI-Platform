...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-black text-white overflow-hidden">
      <div className="fixed inset-0 bg-gradient-to-br from-purple-900/20 via-blue-900/20 tio-green-900/20 animate-pulse" />
      <div
        style={{
        ...
        <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
          <div className="space-y-6 sm:space-y-8 text-center lg:text-left">
            <div className="space-y-4 sm:space-y-6">
              ...
              <p className="text-lg sm:text-xl md:text-2xl text-gray-300 font-light leading-relaxed mx-w-2xl md:max-w-none">
      ...
      <section
        id="features"
        className="relative mt-14 z-10 py-16 sm:py-6 bg-gradient-to-r from-gray-900/50 to-purple-900/20"
      >
      ...
      <section className="relative z-10 py-16 sm:py-24 px-4 sm:px-6">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12 sm:mb-16 lg:mb-20">
            ...
            <p className="text-lg sm:text-xl text-gray-400 max-w-3xl mx-auto px-4">
              Three pwerful modules working together to supercharge your content
              creation.
            </p>
          </div>
