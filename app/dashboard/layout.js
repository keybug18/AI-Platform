...
const DashboardLayout = ({ children }) => {
  ...
  return (
    <div className=" min-h-screen bg-slate-900 text-white ">
      ...
      <aside
        className={cn(
          "fixed top-0 left-0 h-full w-64 border-r bg-slate-800/50 backdrop-blur-sm border-r border-slate-700 z-50 transition-transform duration-300 lg:translate-x-0",
